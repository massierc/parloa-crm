...
export const Modal = ({ open, title, onDismiss, children }: ModalProps) => {
  return (
    <div id="defaultModal" aria-hidden="true" className={`${open ? '' : 'hidden'} overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 w-full md:inset-0 h-modal md:h-full flex justify-center`}>
